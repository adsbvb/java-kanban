...
public class Main {
    public static void main(String[] args) {
        ...
        int subtask1_1 = taskManager.addSubtask(new Subtask("Билеты.", Status.NEW, "Купить.", 3));
        int subtask1_2 = taskManager.addSubtask(new Subtask("Личные вещи.", Status.NEW, "Собрать чемодан.", 3));

        int epic2 = taskManager.createEpic(new Epic("Изучить новую специальность.", Status.NEW, "Освоить язык программирования Java."));
        int subtask2_1 = taskManager.addSubtask(new Subtask("Учеба.", Status.NEW, "Пройти курс на Яндекс-Практикум.", 6));
